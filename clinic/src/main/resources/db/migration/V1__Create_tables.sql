...
CREATE TABLE appointments (
    ...
    FOREIGN KEY (patient_id) REFERENCES patients(identification_number) ON DELETE CASCADE,
...
CREATE TABLE orders (
    ...
    date DATE NOT NULL,
    diagnosis TEXT,
    FOREIGN KEY (patient_identification_number) REFERENCES patients(identification_number) ON DELETE CASCADE,
    FOREIGN KEY (doctor_identification_number) REFERENCES users(id) ON DELETE CASCADE
);
...
CREATE TABLE diagnostic_aid_orders (
    ...
    cost DECIMAL(10,2) NOT NULL,
    FOREIGN KEY (order_number) REFERENCES orders(order_number) ON DELETE CASCADE,
    FOREIGN KEY (diagnostic_aid_id) REFERENCES diagnostic_aids(id) ON DELETE CASCADE,
    FOREIGN KEY (specialist_id) REFERENCES users(id) ON DELETE SET NULL,
    UNIQUE(order_number, item)
);
